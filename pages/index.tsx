                ...
                <div className={styles.headerInner}>
                    <div>
                        ...
                        <p className={styles.subtitle}>
                            Список обновляется автоматически. Статус &laquo;Доступен&raquo; означает, что прокси успешно отвечает на запросы из стран Европы и Америки. Доступность сервера в вашей сети и на вашем устройстве проверяйте на этапе подключения в Telegram.
                        </p>
                    </div>
                </div>
            </header>
